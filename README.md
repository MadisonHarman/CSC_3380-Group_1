...
2. **Calendar**: Add daily agenda items like flights, meals, check-ins, etc.
3. **Calendar View**: Plan your trip timeline in a monthly calendar.
4. **Weather**: Search cities to see the weather in °F.
...
3. **Calendar:** Pick a date, add activities, set times, and choose reminder notifications.  
4. **Calendar View:** Navigate through months to see all scheduled activities.  
5. **Weather:** Type a city name, click 'Search', and 7-day forecast is shown.  
6. **Packing List:** Edit a list freely or generate suggestions. 
7. You can close or return to the website any time; the data is stored locally.
